...
public class nothing {
    ...
    public static Sprite wall = new Sprite(DEFAULT_SIZE, 7, 0, SpriteSheet.tiles, 16, 16);
    ...
    public static Sprite captain = new Sprite(32, 0, 0, SpriteSheet.captain, 32, 48);
